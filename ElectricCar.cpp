...
void ElectricCar::charge() {
    if (electricEngine_->currentBatteryCapacity_ == electricEngine_->maxBatteryCapacity_) {
        throw InvalidRestore("Your battery is full.");
    } else {
        electricEngine_->currentBatteryCapacity_ = electricEngine_->maxBatteryCapacity_;
    }
}
